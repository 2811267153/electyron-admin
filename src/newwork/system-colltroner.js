...
export function getSystemParameters(data) {
  return request({
    url: "/pbx/sysparams/list",
    params: data
  });
}

export function addSystemParameters(data) {
  return request({
    url: "/pbx/sysparams/add",
    method: "post",
    data
  });
}

export function upDataParameters(data) {
  return request({
    url: "/pbx/sysparams/update",
    method: "put",
    data
  });
}

export function delSystemParameters(data) {
  return request({
    url: "/pbx/sysparams/delete/" + data,
    method: "delete"
  });
}
