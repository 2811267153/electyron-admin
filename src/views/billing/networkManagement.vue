      ...
      <el-form :inline="true" :model="from" class="demo-form-inline">
        ...
        <el-form-item label="协议类型">
          <el-select v-model="from.protocol" placeholder="协议类型">
            <el-option :label="item.label" :value="item.value" v-for="item in protocolType"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="中继类型">
          <el-select v-model="from.relay" placeholder="中继类型">
            <el-option :label="item.label" :value="item.value" v-for="item in relayType"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="录音支持">
          <el-select v-model="from.recording" placeholder="活动区域">
            <el-option :label="item.label" :value="item.value" v-for="item in recording"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="网管状态">
          <el-select v-model="from.networkStat" placeholder="活动区域">
            <el-option :label="item.label" :value="item.value" v-for="item in networkStat"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
...
<!--          <el-button @click="onSubmit">重置</el-button>-->
      ...
      <el-button type="primary" @click="showAddForm(null, '添加网管')">添加网管</el-button>
    </div>
    <el-dialog :title="title" :visible.sync="dialogFormVisible">
      <el-form :model="addFrom" ref="formName" :rules="rules">
        <div class="width">
          <el-form-item label="网管名称" :label-width="formLabelWidth" prop="name">
            <el-input v-model="addFrom.name" autocomplete="off"></el-input>
          </el-form-item>
        </div>
        <div class="width">
          <el-form-item label="域地址" :label-width="formLabelWidth" prop="hostAddress">
            <el-input v-model="addFrom.hostAddress" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="代理地址" :label-width="formLabelWidth" prop="proxyAddress">
            <el-input v-model="addFrom.proxyAddress" autocomplete="off"></el-input>
          </el-form-item>
        </div>
        <div class="width">
          ...
          <el-form-item label="中继类型" :label-width="formLabelWidth" prop="relay">
        ...
        <div class="width">
          <el-form-item label="替换后号码" :label-width="formLabelWidth" prop="behindNum">
            <el-input v-model="addFrom.behindNum" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="最大并发数" :label-width="formLabelWidth" prop="maxComplicating" >
        ...
        <div class="width">
          <el-form-item label="失效时间" :label-width="formLabelWidth" prop="failureTime">
            <el-input v-model="addFrom.failureTime"/>
          </el-form-item>

          <el-form-item label="重连时间" :label-width="formLabelWidth" prop="reconnection">
        ...
        <div class="width">
          ...
          <el-form-item label="密码" :label-width="formLabelWidth" prop="passwords">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template scope="scope">
          <div class="operate">
            <el-link class="a-link" @click="showAddForm(scope.row, '编辑')" type="info">编辑</el-link>
            <el-link class="a-link" @click="removeIt(scope.row)" type="info">删除</el-link>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: '网管名称', trigger: 'blur' },
        ],
        hostAddress: [
        ...
        relay: [
          {  required: true, message: '请选择中继类型', trigger: 'blur' }
        ],
        behindNum: [
