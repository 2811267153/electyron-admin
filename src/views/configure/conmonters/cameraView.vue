  ...
  <div id="camera">
    ...
    <div class="container">
      ...
      <div class="nav-form">
        ...
        <div>
          <el-button type="primary" @click="showAddForm(null, '新增设备')">新增设备</el-button>
        ...
        <el-form :rules="rules" ref="ruleForm" :model="addForm">
          <div class="width">
            <el-form-item label="设备名称" :label-width="formLabelWidth" prop="name">
              <el-input v-model="addForm.name" autocomplete="off" :readonly="isReadOnly"></el-input>
            </el-form-item>
            <el-form-item label="序列号" :label-width="formLabelWidth" prop="serialNumber">
              <el-input v-model="addForm.serialNumber" autocomplete="off" :readonly="isReadOnly"></el-input>
            </el-form-item>
          </div>
          <div class="width">
            <el-form-item  label="设备厂商" :label-width="formLabelWidth" prop="company">
              <el-select v-model="addForm.company" placeholder="请选择" :disabled="isReadOnly" >
                <el-option
            ...
            <el-form-item label="设备类型" :label-width="formLabelWidth" prop="type">
              <el-select v-model="addForm.type" placeholder="请选择" :disabled="isReadOnly">
                <el-option
                    v-for="item in typeData"
                    :key="item.value"
                    :label="item.label"
          ...
          <el-form-item label="设备IP" :label-width="formLabelWidth" >
            <el-input v-model="addForm.ip" autocomplete="off" :readonly="isReadOnly"></el-input>
          </el-form-item>
          <el-form-item label="端口" :label-width="formLabelWidth">
            <el-input v-model="addForm.host" autocomplete="off" :readonly="isReadOnly"></el-input>
          </el-form-item>
        </div>

          <div class="width">
            <el-form-item label="账户" :label-width="formLabelWidth">
              <el-input v-model="addForm.account" autocomplete="off" :readonly="isReadOnly"></el-input>
            </el-form-item>
            <el-form-item label="密码" :label-width="formLabelWidth" >
              <el-input v-model="addForm.password" autocomplete="off" :readonly="isReadOnly"></el-input>
            </el-form-item>
          </div>
          ...
          <el-form-item label="设备位置" :label-width="formLabelWidth">
            <div v-if="addForm.address.x != ''">
              ...
              {{this.addForm.address.street }}</div>
            <div v-else>请在下图中选择坐标</div>
            <baiduMap id="baidu-map" ak="qF2OlD0Gin1GwwqYTHR3cQ8dqfcfZhtZ"  center="北京">
              <bm-view style="width: 100%; height:400px; flex: 1"></bm-view>
              <Geolocation :autoLocation='true' @locationSuccess='locationSuccess'></Geolocation>
            </baiduMap>
          </el-form-item>
        </el-form>
      ...
      <el-table
        ...
        <el-table-column
            ...
            width="300">
          <template scope="scope">
            <div>{{scope.row.address.province}}{{scope.row.address.city}}{{scope.row.address.district}}{{scope.row.address.street}}</div>
          </template>
        </el-table-column>
        <el-table-column
            prop="stauts"
