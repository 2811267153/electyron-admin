<template>
  <!--  字典管理-->
  <div class="container" style="height: 100%; margin-top: 0">
    <div class="nav-form">
      ...
      <a>
        <el-button type="primary" @click="black"
        >返回
        </el-button
        >
...
import { addDictionary, getDictionaryAll, removeDictionary, upData } from "@/newwork/system-colltroner";
